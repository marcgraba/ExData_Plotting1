...
plot(data$V5 ~ data$DateTime,ylab="Voltage",xlab="datetime",type="l")
...
legend("topright",lty=c(1,1),lwd=c(2.5,2.5),col=c("black","red","blue"),legend=c("Sub_metering_1 ","Sub_metering_2 ","Sub_metering_3 "),bty="n")
plot(data$V4 ~ data$DateTime,ylab="Global_reactive_power",xlab="datetime",type="l")
